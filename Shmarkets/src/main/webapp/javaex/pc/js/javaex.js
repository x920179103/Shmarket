	...
	var javaex = function() {
		...
		var info = {
			...
			comment : function(args) {
				...
				var html = '';
				html += '<div class="comment-form"><div class="form-textwrap"><textarea class="comment-textarea original" placeholder="我来说两句..."></textarea></div>';
				html += '<div style="text-align:right;">';
				html += '<button class="button blue" onclick="javaex.javaexComment(this, attribute)">发表评论</button>';
				html += '</div></div>';
...
//						html += '<a href="javascript:;" class="fold">查看更多回复<i class="icon-keyboard_arrow_right"></i></a>';
			...
			javaexShowReplyTextarea1 : function(obj, args) {
				...
				if (posrLength==0) {
					var html = '';
					html += '<div class="posr">';
					html += '<textarea class="comment-textarea comment-textarea-reply"></textarea>';
					html += '<div style="text-align:right;">';
			...
			deleteDialog : function(obj, args) {
				...
				// 弹出层代码
				var html = '<div id='+UUID+' class="ex-danger-dialog win animated fadeInUpSmall" style="left:'+parseInt(left-186+(obj.offsetWidth/2)+30)+'px;top:'+parseInt(top+obj.offsetHeight-48)+'px;">';
